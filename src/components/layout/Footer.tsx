...
const LINKS = {
  directory: [
    ...
    { label: 'Best AI Agents & LLMs', href: '/ai-agents' },
    ...
    <footer className="w-full border-t border-gray-200 bg-gray-50 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a href="https://twitter.com/aiverse" target="_blank" rel="noopener noreferrer"
                className="p-2 rounded-lg bg-white border border-gray-200 text-gray-500 hover:text-violet-700 hover:border-violet-300 transition-all">
          ...
          {/* Directory */}
          <div>
            <h4 className="text-gray-900 font-bold text-sm mb-4 uppercase tracking-wider">Directory</h4>
            <ul className="space-y-2.5">
              {LINKS.directory.map(l => (
                <li key={l.label}>
                  <Link href={l.href as '/'}
                    className="text-gray-600 hover:text-violet-700 text-sm transition-colors duration-200">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Monetize */}
          <div>
            <h4 className="text-gray-900 font-bold text-sm mb-4 uppercase tracking-wider">For Tool Makers</h4>
            <ul className="space-y-2.5">
          ...
          {/* Company */}
          <div>
            <h4 className="text-gray-900 font-bold text-sm mb-4 uppercase tracking-wider">Company</h4>
            <ul className="space-y-2.5">
              {LINKS.company.map(l => (
                <li key={l.label}>
                  <Link href={l.href as '/'}
