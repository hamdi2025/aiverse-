...
import { Bot, Presentation, Table2, Box, Search, FileText, Archive, RefreshCw, Languages, MessageSquare, BarChart2, Users, DollarSign } from 'lucide-react';
    ...
    <div className="w-full overflow-x-auto no-scrollbar py-4">
      <div className="flex flex-wrap gap-2 px-4 md:px-0 justify-center">
        {categories.map((cat) => {
          ...
          const isSpecial = cat.id === 'agents' || cat.id === 'translation';
          return (
            <button
              key={cat.id}
            ...
            >
              ...
              {cat.badge && (
                <span className={clsx(
                  ...
                  cat.badge === 'NEW' ? 'text-green-400 bg-green-400/10 border-green-400/20' : 'text-amber-400 bg-amber-400/10 border-amber-400/20'
                )}>
                  {cat.badge}
                </span>
              )}
