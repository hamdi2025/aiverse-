...
export default function SearchBar({
  ...
  const categories = [
    ...
    { id: 'translation',  label: tCat('translation') },
    { id: 'chatbots',     label: tCat('chatbots') },
    { id: 'data',         label: tCat('data') },
    { id: 'hr',           label: tCat('hr') },
    { id: 'finance',      label: tCat('finance') },
    { id: 'contract',     label: tCat('contract') },
    { id: 'projectmgmt',  label: tCat('projectmgmt') },
    { id: 'mindmap',      label: tCat('mindmap') },
    { id: 'elearning',    label: tCat('elearning') },
    { id: 'legal',        label: tCat('legal') },
    { id: 'cybersecurity',label: tCat('cybersecurity') },
    { id: 'socialmedia',  label: tCat('socialmedia') },
    { id: 'travel',       label: tCat('travel') },
    { id: 'slides',       label: tCat('slides') },
    { id: 'excel',        label: tCat('excel') },
    { id: 'design3d',     label: tCat('design3d') },
    { id: 'seo',          label: tCat('seo') },
    { id: 'pdf',          label: tCat('pdf') },
    { id: 'compression',  label: tCat('compression') },
    { id: 'conversion',   label: tCat('conversion') },
  ];
