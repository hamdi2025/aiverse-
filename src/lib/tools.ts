...
export const TOOLS_DATA: AITool[] = [
  ...
  { id: 'recraft-ai', name: 'Recraft AI', category: 'image',
    ...
    rating: 4.7, pricing: 'Freemium', pricingLocalized: { en: 'Free / $12/mo', fr: 'Gratuit / 12$/mois', es: 'Gratis / $12/mes', ar: 'مجاني / 12 دولار' }, websiteUrl: 'https://recraft.ai', views: 19000 },
  { id: 'blackbox-ai', name: 'Blackbox AI', category: 'code',
    ...
    rating: 4.4, pricing: 'Freemium', pricingLocalized: { en: 'Free / $9.99/mo', fr: 'Gratuit / 9.99$/mois', es: 'Gratis / $9.99/mes', ar: 'مجاني / 9.99 دولار' }, websiteUrl: 'https://blackbox.ai', views: 20000 },
  { id: 'gumloop', name: 'Gumloop', category: 'agents',
    ...
    rating: 4.5, pricing: 'Freemium', pricingLocalized: { en: 'Free / $29/mo', fr: 'Gratuit / 29$/mois', es: 'Gratis / $29/mes', ar: 'مجاني / 29 دولار' }, websiteUrl: 'https://gumloop.com', views: 13000 },
  { id: 'grammarly-ai', name: 'Grammarly AI', category: 'writing',
    ...
    rating: 4.7, pricing: 'Freemium', pricingLocalized: { en: 'Free / $12/mo', fr: 'Gratuit / 12$/mois', es: 'Gratis / $12/mes', ar: 'مجاني / 12 دولار' }, websiteUrl: 'https://grammarly.com', views: 55000 },
  ...
  { id: 'fireflies-ai', name: 'Fireflies.ai', category: 'productivity',
    ...
    rating: 4.6, pricing: 'Freemium', pricingLocalized: { en: 'Free / $10/mo', fr: 'Gratuit / 10$/mois', es: 'Gratis / $10/mes', ar: 'مجاني / 10 دولار' }, websiteUrl: 'https://fireflies.ai', views: 22000 },
  { id: 'loom-ai', name: 'Loom AI', category: 'productivity',
    ...
    rating: 4.5, pricing: 'Freemium', pricingLocalized: { en: 'Free / $12.50/mo', fr: 'Gratuit / 12.50$/mois', es: 'Gratis / $12.50/mes', ar: 'مجاني / 12.50 دولار' }, websiteUrl: 'https://loom.com', views: 28000 },
  { id: 'tome-ai', name: 'Tome', category: 'productivity',
    ...
    rating: 4.4, pricing: 'Freemium', pricingLocalized: { en: 'Free / $16/mo', fr: 'Gratuit / 16$/mois', es: 'Gratis / $16/mes', ar: 'مجاني / 16 دولار' }, websiteUrl: 'https://tome.app', views: 20000 },
  ...
  { id: 'remove-bg', name: 'Remove.bg', category: 'image',
    ...
    rating: 4.6, pricing: 'Freemium', pricingLocalized: { en: 'Free / $9/mo', fr: 'Gratuit / 9$/mois', es: 'Gratis / $9/mes', ar: 'مجاني / 9 دولار' }, websiteUrl: 'https://remove.bg', views: 40000 },
  { id: 'flair-ai', name: 'Flair AI', category: 'image',
    ...
    rating: 4.5, pricing: 'Freemium', pricingLocalized: { en: 'Free / $10/mo', fr: 'Gratuit / 10$/mois', es: 'Gratis / $10/mes', ar: 'مجاني / 10 دولار' }, websiteUrl: 'https://flair.ai', views: 16000 },
  { id: 'fliki-ai', name: 'Fliki', category: 'video',
    ...
    rating: 4.4, pricing: 'Freemium', pricingLocalized: { en: 'Free / $21/mo', fr: 'Gratuit / 21$/mois', es: 'Gratis / $21/mes', ar: 'مجاني / 21 دولار' }, websiteUrl: 'https://fliki.ai', views: 18000 },
  ...
  { id: 'vapi-ai', name: 'Vapi', category: 'agents',
    ...
    rating: 4.6, pricing: 'Freemium', pricingLocalized: { en: 'Free / $0.05/min', fr: 'Gratuit / 0.05$/min', es: 'Gratis / $0.05/min', ar: 'مجاني / 0.05 دولار/دقيقة' }, websiteUrl: 'https://vapi.ai', views: 17000 },
  ...
  { id: 'durable-ai', name: 'Durable', category: 'marketing',
    ...
    rating: 4.3, pricing: 'Paid', pricingLocalized: { en: 'From $12/mo', fr: 'A partir de 12$/mois', es: 'Desde $12/mes', ar: 'تبدأ من 12 دولار' }, websiteUrl: 'https://durable.co', views: 13000 },
  { id: 'framer-ai', name: 'Framer AI', category: 'marketing',
    ...
    rating: 4.6, pricing: 'Freemium', pricingLocalized: { en: 'Free / $15/mo', fr: 'Gratuit / 15$/mois', es: 'Gratis / $15/mes', ar: 'مجاني / 15 دولار' }, websiteUrl: 'https://framer.com', views: 22000 },
  ...
  { id: 'wegic', name: 'Wegic', category: 'marketing',
    ...
    rating: 4.4, pricing: 'Freemium', pricingLocalized: { en: 'Free / $9.9/mo', fr: 'Gratuit / 9.9$/mois', es: 'Gratis / $9.9/mes', ar: 'مجاني / 9.9 دولار' }, websiteUrl: 'https://wegic.ai', views: 12000 },
  { id: 'typeframes', name: 'Typeframes', category: 'video',
    ...
    rating: 4.3, pricing: 'Freemium', pricingLocalized: { en: 'Free / $29/mo', fr: 'Gratuit / 29$/mois', es: 'Gratis / $29/mes', ar: 'مجاني / 29 دولار' }, websiteUrl: 'https://typeframes.com', views: 10000 },
  { id: 'locofy-ai', name: 'Locofy', category: 'code',
    ...
    rating: 4.4, pricing: 'Freemium', pricingLocalized: { en: 'Free / $29/mo', fr: 'Gratuit / 29$/mois', es: 'Gratis / $29/mes', ar: 'مجاني / 29 دولار' }, websiteUrl: 'https://locofy.ai', views: 14000 },
  { id: 'bland-ai', name: 'Bland AI', category: 'agents',
    ...
    rating: 4.4, pricing: 'Freemium', pricingLocalized: { en: 'Free / $0.09/min', fr: 'Gratuit / 0.09$/min', es: 'Gratis / $0.09/min', ar: 'مجاني / 0.09 دولار/دقيقة' }, websiteUrl: 'https://bland.ai', views: 13000 }
