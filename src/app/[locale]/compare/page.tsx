        ...
        <div className="grid grid-cols-1 md:grid-cols-7 gap-3 items-center mb-4">
          ...
          <div className="flex items-stretch justify-center">
            <button
              ...
              className={`w-full min-h-[52px] flex flex-col items-center justify-center gap-1 rounded-2xl font-black text-xs px-2 ${
                canCompare
                  ? 'compare-attract shadow-lg hover:opacity-90'
                  : 'bg-gray-100 text-gray-600 border-2 border-gray-200 cursor-not-allowed transition-all'
              }`}
            >
