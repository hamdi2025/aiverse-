...
export default function ContactPage({ params }: Props) {
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-16">
      ...
      <h1 className="text-3xl sm:text-4xl font-black text-white mt-6 mb-6">Contact Us</h1>
      ...
      <div className="space-y-6 text-gray-300 leading-relaxed text-[15px]">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 space-y-3">
          <p className="text-white font-semibold">General &amp; editorial</p>
          <p><a className="text-[#7C3AED] hover:underline" href="mailto:contact@getaiverse.online">contact@getaiverse.online</a></p>
          <p className="text-white font-semibold pt-2">Advertising &amp; partnerships</p>
        ...
        <h2 className="text-xl font-bold text-white pt-4">Suggest or Submit a Tool</h2>
        ...
        <h2 className="text-xl font-bold text-white pt-4">Report an Error</h2>
