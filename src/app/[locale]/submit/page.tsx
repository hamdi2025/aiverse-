...
const T = {
  en: {
    ...
    featFeatures: ['Everything in Standard', '"Sponsor" gold badge', 'Homepage hero placement', 'Dedicated weekly spotlight', 'Sponsored placement (rel="sponsored", Google-compliant)', 'Monthly analytics report', 'Social media mention'],
  ...
  fr: {
    ...
    featFeatures: ["Tout ce qu'il y a dans Standard", 'Badge or "Sponsor"', 'Placement hero en page d\'accueil', 'Spotlight hebdomadaire dédié', 'Placement sponsorisé (rel="sponsored", conforme Google)', 'Rapport analytics mensuel', 'Mention sur les réseaux sociaux'],
  ...
  es: {
    ...
    featFeatures: ['Todo lo de Estándar', 'Badge dorado "Sponsor"', 'Colocación en hero', 'Spotlight semanal dedicado', 'Ubicación patrocinada (rel="sponsored", conforme a Google)', 'Informe mensual de analíticas', 'Mención en redes sociales'],
  ...
  ar: {
    ...
    featFeatures: ['كل ما في القياسي', 'شارة ذهبية "Sponsor"', 'وضع في صفحة الرئيسية', 'تسليط الضوء أسبوعياً', 'موضع برعاية (rel="sponsored" وفق سياسات Google)', 'تقرير تحليلي شهري', 'ذِكر على وسائل التواصل'],
    featCta: 'كن راعياً →',
