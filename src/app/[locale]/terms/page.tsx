...
export default function TermsPage({ params }: Props) {
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-16">
      ...
      <h1 className="text-3xl sm:text-4xl font-black text-gray-900 mt-6 mb-2">Terms of Service</h1>
      ...
      <div className="space-y-6 text-gray-700 leading-relaxed text-[15px]">
        ...
        <h2 className="text-xl font-bold text-gray-900 pt-4">1. About the Service</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 pt-4">2. No Affiliation or Endorsement</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 pt-4">3. Informational Purpose &amp; No Warranty</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 pt-4">4. Affiliate Relationships</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 pt-4">5. Acceptable Use</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 pt-4">6. User Submissions</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 pt-4">7. Intellectual Property</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 pt-4">8. Limitation of Liability</h2>
        ...
        <h2 className="text-xl font-bold text-gray-900 pt-4">9. Changes to These Terms</h2>
