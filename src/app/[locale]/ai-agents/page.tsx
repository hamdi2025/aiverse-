...
const ROWS: { id: string; type: Record<Locale, string>; best: Record<Locale, string>; open: boolean; spec: string }[] = [
  ...
  { id: 'genspark', type: { en: 'Autonomous agent', fr: 'Agent autonome', es: 'Agente autónomo', ar: 'وكيل مستقل' }, best: { en: 'Multi-agent workspace to research, build & ship', fr: 'Espace multi-agents pour rechercher, construire et livrer', es: 'Espacio multi-agente para investigar, construir y entregar', ar: 'مساحة متعددة الوكلاء للبحث والبناء والتسليم' }, open: false, spec: 'Genspark Claw · from $19.99/mo' },
  { id: 'kimi-claw', type: { en: 'Autonomous agent', fr: 'Agent autonome', es: 'Agente autónomo', ar: 'وكيل مستقل' }, best: { en: 'Budget browser automation on open Kimi models', fr: 'Automatisation navigateur économique sur modèles Kimi ouverts', es: 'Automatización de navegador económica sobre modelos Kimi abiertos', ar: 'أتمتة متصفّح اقتصادية على نماذج Kimi المفتوحة' }, open: true, spec: 'Manus rival · low-cost' },
  { id: 'relay-app', type: { en: 'No-code agent', fr: 'Agent no-code', es: 'Agente no-code', ar: 'وكيل بدون برمجة' }, best: { en: 'No-code AI automation with human approval', fr: 'Automatisation IA no-code avec validation humaine', es: 'Automatización de IA no-code con aprobación humana', ar: 'أتمتة ذكاء اصطناعي بدون برمجة بموافقة بشرية' }, open: false, spec: 'Free · GPT/Claude/Gemini' },
  { id: 'glean', type: { en: 'Enterprise agent', fr: 'Agent entreprise', es: 'Agente empresarial', ar: 'وكيل مؤسسات' }, best: { en: 'Enterprise search & agents over company data', fr: 'Recherche & agents entreprise sur les données internes', es: 'Búsqueda y agentes empresariales sobre datos internos', ar: 'بحث ووكلاء للمؤسسات على بيانات الشركة' }, open: false, spec: 'From $30/seat/mo' },
  { id: 'lindy', type: { en: 'Business agent', fr: 'Agent métier', es: 'Agente de negocio', ar: 'وكيل أعمال' }, best: { en: 'No-code AI employees for email, CRM & support', fr: 'Employés IA no-code pour e-mail, CRM et support', es: 'Empleados de IA no-code para email, CRM y soporte', ar: 'موظفو ذكاء اصطناعي بدون برمجة للبريد وCRM والدعم' }, open: false, spec: '3,000+ integrations · from $30/mo' },
  { id: 'multion', type: { en: 'Web agent', fr: 'Agent web', es: 'Agente web', ar: 'وكيل ويب' }, best: { en: 'API to embed autonomous web actions', fr: 'API pour intégrer des actions web autonomes', es: 'API para integrar acciones web autónomas', ar: 'API لدمج إجراءات ويب مستقلّة' }, open: false, spec: 'Usage-based API' },
  { id: 'bardeen', type: { en: 'Browser agent', fr: 'Agent navigateur', es: 'Agente navegador', ar: 'وكيل متصفّح' }, best: { en: 'Repetitive web tasks for sales & ops', fr: 'Tâches web répétitives pour vente & ops', es: 'Tareas web repetitivas para ventas y ops', ar: 'مهام ويب متكرّرة للمبيعات والعمليات' }, open: false, spec: 'Free · from $20/mo' },
  { id: 'aomni', type: { en: 'Research agent', fr: 'Agent de recherche', es: 'Agente de investigación', ar: 'وكيل بحث' }, best: { en: 'Autonomous sales account research', fr: 'Recherche de comptes vente autonome', es: 'Investigación autónoma de cuentas de ventas', ar: 'بحث حسابات المبيعات المستقلّ' }, open: false, spec: 'GTM intelligence' },
  { id: 'runner-h', type: { en: 'Computer-use agent', fr: 'Agent computer-use', es: 'Agente computer-use', ar: 'وكيل استخدام الحاسوب' }, best: { en: 'End-to-end computer & web tasks', fr: 'Tâches ordinateur & web de bout en bout', es: 'Tareas de ordenador y web de extremo a extremo', ar: 'مهام حاسوب وويب من البداية للنهاية' }, open: false, spec: 'Agentic action model' },
  { id: 'simular', type: { en: 'Computer-use agent', fr: 'Agent computer-use', es: 'Agente computer-use', ar: 'وكيل استخدام الحاسوب' }, best: { en: 'Open agent that controls your computer', fr: 'Agent ouvert qui pilote votre ordinateur', es: 'Agente abierto que controla tu ordenador', ar: 'وكيل مفتوح يتحكّم بحاسوبك' }, open: true, spec: 'Agent S · open' },
  { id: 'lutra', type: { en: 'No-code agent', fr: 'Agent no-code', es: 'Agente no-code', ar: 'وكيل بدون برمجة' }, best: { en: 'Build data workflows in plain language', fr: 'Créer des workflows data en langage naturel', es: 'Crear flujos de datos en lenguaje natural', ar: 'بناء سير عمل بيانات بلغة طبيعية' }, open: false, spec: 'Gmail/Sheets/Slack' },
  { id: 'convergence-proxy', type: { en: 'Personal web agent', fr: 'Agent web personnel', es: 'Agente web personal', ar: 'وكيل ويب شخصي' }, best: { en: 'Learns your routines to browse for you', fr: 'Apprend vos routines pour naviguer à votre place', es: 'Aprende tus rutinas para navegar por ti', ar: 'يتعلّم عاداتك ليتصفّح نيابةً عنك' }, open: false, spec: 'Proxy · free tier' },
  { id: 'emergence-ai', type: { en: 'Enterprise agent', fr: 'Agent entreprise', es: 'Agente empresarial', ar: 'وكيل مؤسسات' }, best: { en: 'Orchestrating fleets of agents at scale', fr: 'Orchestrer des flottes d\'agents à l\'échelle', es: 'Orquestar flotas de agentes a escala', ar: 'تنسيق أساطيل من الوكلاء على نطاق واسع' }, open: false, spec: 'Enterprise orchestration' },
  { id: 'camel-ai', type: { en: 'Open framework', fr: 'Framework ouvert', es: 'Framework abierto', ar: 'إطار مفتوح' }, best: { en: 'Research on multi-agent societies', fr: 'Recherche sur les sociétés multi-agents', es: 'Investigación en sociedades multi-agente', ar: 'أبحاث مجتمعات متعددة الوكلاء' }, open: true, spec: 'Multi-agent · open source' },
  { id: 'open-interpreter', type: { en: 'Local agent', fr: 'Agent local', es: 'Agente local', ar: 'وكيل محلي' }, best: { en: 'Run code on your computer by chat', fr: 'Exécuter du code sur votre PC par chat', es: 'Ejecutar código en tu PC por chat', ar: 'تشغيل الشيفرة على حاسوبك بالمحادثة' }, open: true, spec: 'Free · MIT/Apache' },
  { id: 'openhands', type: { en: 'Coding agent', fr: 'Agent de code', es: 'Agente de código', ar: 'وكيل برمجة' }, best: { en: 'Free autonomous coding (Devin alternative)', fr: 'Codage autonome gratuit (alt. Devin)', es: 'Codificación autónoma gratis (alt. Devin)', ar: 'برمجة مستقلّة مجانية (بديل Devin)' }, open: true, spec: '70K+ stars · free' },
  { id: 'smolagents', type: { en: 'Agent framework', fr: 'Framework d\'agents', es: 'Framework de agentes', ar: 'إطار وكلاء' }, best: { en: 'Minimal, code-first agents (Hugging Face)', fr: 'Agents minimalistes code-first (Hugging Face)', es: 'Agentes minimalistas code-first (Hugging Face)', ar: 'وكلاء مبسّطون code-first (Hugging Face)' }, open: true, spec: '~1K lines · free' },
  { id: 'suna', type: { en: 'Generalist agent', fr: 'Agent généraliste', es: 'Agente generalista', ar: 'وكيل عام' }, best: { en: 'Self-hosted Manus alternative', fr: 'Alternative auto-hébergée à Manus', es: 'Alternativa autoalojada a Manus', ar: 'بديل ذاتي الاستضافة لـ Manus' }, open: true, spec: 'Free self-host' },
  { id: 'magentic-one', type: { en: 'Multi-agent', fr: 'Multi-agents', es: 'Multi-agente', ar: 'متعدد الوكلاء' }, best: { en: 'Free generalist agent team (Microsoft)', fr: 'Équipe d\'agents généraliste gratuite (Microsoft)', es: 'Equipo de agentes generalista gratis (Microsoft)', ar: 'فريق وكلاء عام مجاني (Microsoft)' }, open: true, spec: 'On AutoGen · free' },
  { id: 'stagehand', type: { en: 'Web agent', fr: 'Agent web', es: 'Agente web', ar: 'وكيل ويب' }, best: { en: 'Reliable web automation (Playwright + AI)', fr: 'Automatisation web fiable (Playwright + IA)', es: 'Automatización web fiable (Playwright + IA)', ar: 'أتمتة ويب موثوقة (Playwright + ذكاء اصطناعي)' }, open: true, spec: 'Browserbase · free' },
  { id: 'nanobrowser', type: { en: 'Browser agent', fr: 'Agent navigateur', es: 'Agente navegador', ar: 'وكيل متصفّح' }, best: { en: 'Multi-agent automation in your Chrome', fr: 'Automatisation multi-agents dans votre Chrome', es: 'Automatización multi-agente en tu Chrome', ar: 'أتمتة متعددة الوكلاء في Chrome لديك' }, open: true, spec: 'Free · your API keys' },
  { id: 'agno', type: { en: 'Agent framework', fr: 'Framework d\'agents', es: 'Framework de agentes', ar: 'إطار وكلاء' }, best: { en: 'Fast production agents (ex-Phidata)', fr: 'Agents production rapides (ex-Phidata)', es: 'Agentes de producción rápidos (ex-Phidata)', ar: 'وكلاء إنتاج سريعون (سابقاً Phidata)' }, open: true, spec: 'Free · open source' },
  { id: 'openai-agents-sdk', type: { en: 'Agent framework', fr: 'Framework d\'agents', es: 'Framework de agentes', ar: 'إطار وكلاء' }, best: { en: 'Simple multi-agent workflows (OpenAI)', fr: 'Workflows multi-agents simples (OpenAI)', es: 'Flujos multi-agente simples (OpenAI)', ar: 'سير عمل متعدّد الوكلاء بسيط (OpenAI)' }, open: true, spec: 'Free SDK · Swarm successor' },
  { id: 'google-adk', type: { en: 'Agent framework', fr: 'Framework d\'agents', es: 'Framework de agentes', ar: 'إطار وكلاء' }, best: { en: 'Build & deploy agents (Google)', fr: 'Construire & déployer des agents (Google)', es: 'Construir y desplegar agentes (Google)', ar: 'بناء ونشر الوكلاء (Google)' }, open: true, spec: 'Free · Gemini/Cloud' },
  { id: 'strands-agents', type: { en: 'Agent framework', fr: 'Framework d\'agents', es: 'Framework de agentes', ar: 'إطار وكلاء' }, best: { en: 'Agents in a few lines (AWS)', fr: 'Agents en quelques lignes (AWS)', es: 'Agentes en pocas líneas (AWS)', ar: 'وكلاء بأسطر قليلة (AWS)' }, open: true, spec: 'Free · open source' },
  { id: 'langgraph', type: { en: 'Agent framework', fr: 'Framework d\'agents', es: 'Framework de agentes', ar: 'إطار وكلاء' }, best: { en: 'Controllable stateful agent graphs (LangChain)', fr: 'Graphes d\'agents à état contrôlables (LangChain)', es: 'Grafos de agentes con estado controlables (LangChain)', ar: 'رسوم وكلاء ذات حالة قابلة للتحكّم (LangChain)' }, open: true, spec: 'Free · production-grade' },
];
