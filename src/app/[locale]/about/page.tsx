...
export default function AboutPage({ params }: Props) {
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-16">
      ...
      <h1 className="text-3xl sm:text-4xl font-black text-white mt-6 mb-6">About AIverse</h1>
      ...
      <div className="space-y-6 text-gray-300 leading-relaxed text-[15px]">
        ...
        <h2 className="text-xl font-bold text-white pt-4">Why We Built It</h2>
        ...
        <h2 className="text-xl font-bold text-white pt-4">How We Rate Tools</h2>
        ...
        <h2 className="text-xl font-bold text-white pt-4">Keeping Information Current</h2>
        ...
        <h2 className="text-xl font-bold text-white pt-4">How AIverse Stays Free</h2>
