...
export default function PrivacyPage({ params }: Props) {
  ...
  return (
    <article className="max-w-3xl mx-auto px-4 py-16 prose-invert">
      ...
      <h1 className="text-3xl sm:text-4xl font-black text-white mt-6 mb-2">Privacy Policy</h1>
      ...
      <div className="space-y-6 text-gray-300 leading-relaxed text-[15px]">
        ...
        <h2 className="text-xl font-bold text-white pt-4">2. How We Use Information</h2>
        ...
        <h2 className="text-xl font-bold text-white pt-4">3. Advertising &amp; Google AdSense</h2>
        ...
        <h2 className="text-xl font-bold text-white pt-4">4. Analytics</h2>
        ...
        <h2 className="text-xl font-bold text-white pt-4">5. Affiliate Links</h2>
        ...
        <h2 className="text-xl font-bold text-white pt-4">7. Data Retention &amp; Security</h2>
